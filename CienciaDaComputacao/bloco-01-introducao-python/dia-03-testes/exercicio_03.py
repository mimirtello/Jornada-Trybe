# Faça uma função que valide um e-mail nos seguintes critérios abaixo, lançando uma exceção quando 
# o valor for inválido. Endereços de email válidos devem seguir as seguintes regras:
