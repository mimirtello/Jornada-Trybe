...
function authorBornIn1947() {
  return books.find((nascida)=>nascida.author.birthYear===1947).author.name
}
console.log(authorBornIn1947())

//Exercicio2 - Retorne o nome do livro de menor nome.
...
//Exercicio3 - Encontre o primeiro livro cujo nome possui 26 caracteres.
